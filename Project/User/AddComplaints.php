...
<body>
    <div>
<h1 class="display-4 text-center mb-5">Complaints</h1>
<div>
<h3  class="display-3 text-center mb-5" >Select Branch  for Complaint</h3>
    </div>
    </div>
    ...
    if ($result->num_rows > 0) {
        while ($data = $result->fetch_assoc()) {
            ...
            <div class="card" style="width: 300px;">
                ...
                <div class="space-gap" style="text-align: center;">
                    <a href="Complaint.php?bid=<?php echo $data['branch_id'] ?>" class="button">Complaint Now</a>
                </div>
            </div>
            <?php
        }
