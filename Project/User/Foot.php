        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    <a class="text-white mb-2" href="HomePage.php"><i class="fa fa-angle-right mr-2"></i>Home</a>
                    <a class="text-white mb-2" href="MyBooking.php"><i class="fa fa-angle-right mr-2"></i>My Bookings</a>
                    <a class="text-white mb-2" href="MyProfile.php"><i class="fa fa-angle-right mr-2"></i>My Profile</a>
                    <a class="text-white mb-2" href="MyPackage.php"><i class="fa fa-angle-right mr-2"></i> My Package</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
