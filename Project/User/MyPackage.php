 ...
 if($data=$result->fetch_assoc())
{
	?>
	 <td width="93" height="333" align="center" >
       <img src="../Assets/Files/Package/<?php echo $data['package_photo'];?>" style="height: 250px; width: 350px;"/>
    	  <p style="color: black; font-weight: bold; font-size: 24px; "><?php echo $data["package_name"];?></p>
