    ...
    <section class="main-pd-wrapper" style="width: 1000px; margin: auto" id="content">
        ...
        <table style="width: 100%; table-layout: fixed">
          <tr>
            ...
            >
              ...
              >
              <div>
              <img src="../Assets/Files/Logo/Logo.png" alt="" />
              </div>
      ...
      >
        <thead style="display: table-header-group">
          ...
          >
            <td colspan="3">
              <p style="color: black;">Booking Date:- <?php echo $data["booking_date"] ?></p>
              <p style="margin: 5px 0; color: black;">Invoice Generated:- <?php echo date("Y-m-d"); ?></p>
            </td>
        ...
        <tbody>
          <?php
          $selCloth="SELECT * from tbl_cloth c inner join tbl_subcategory s on s.subcategory_id=c.subcategory_id inner join tbl_category ct on ct.category_id=s.category_id where c.booking_id=".$data['booking_id'];
          ...
          <tr>
            <td><?php echo $i ?></td>
            <td><?php echo $dataCloth["category_name"]."/".$dataCloth["subcategory_name"] ?></td>
            <td><?php
      ...
      <table class="hm-p table-bordered" style="width: 100%; margin-top: 30px">
        ...
        <tr style="background: #194376">
          ...
          <td style="width: 70px; text-align: right; border-right: none">
            <b style="color: white;"><?php echo $discountPerc  ?></b>
          </td>
          <td colspan="5" style="border-left: none"></td>
        </tr>
        <tr style="background: #194376">
          ...
          <td style="width: 70px; text-align: right; border-right: none">
            <b style="color: white;"><?php echo $sumTotal-$discountPerc  ?></b>
          </td>
          <td colspan="5" style="border-left: none"></td>
        </tr>
      </table>
