        ...
        <form action="" method="post" enctype="multipart/form-data">
            <table border='1'>
                ...
                <tr class="data-row">
                    ...
                    <td>
                        <select name="sl_subcategory[]" class="sl-subcategory" required>
                            <option>--Select--</option>
                        </select>
                    </td>
                    <td>
                    ...
                    <td>
                        <input type="text" name="txt_clothcount[]" onkeyup="calculatePrice(this)" class="txt-clothcount" required/>
                    </td>
                    <td>
                ...
                <input type="hidden" name="total_amount" id="total-amount-input" value="0">
                    <td colspan="8" align="right" id="total-amount" style="color: black; font-weight: bold;">
                        Total Amount : 0
                    </td>
                </tr>
            </table>
            <input type="submit" value="Submit" name="btn_save" style="color: blue;" />
        </form>
    </body>
