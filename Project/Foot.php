...
<div class="container-fluid bg-primary text-white mt-5 pt-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                <a href="index.html"><video autoplay loop muted  width="300" height="100">
                    <source src="../Project/Assets/Files/Logo/LaunFooter.mp4" type="video/mp4">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white mb-2" href="Package.php"><i class="fa fa-angle-right mr-2"></i>Packages</a>
                    <a class="text-white" href="Guest/Login.php"><i class="fa fa-angle-right mr-2"></i>Login</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
    ...
    <script>
        // Add a JavaScript function to toggle the box-hover class on hover
        document.querySelectorAll(".p-3").forEach(function(box) {
