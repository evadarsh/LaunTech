...
?>
        <script>
            ...
            window.location = "WashingFinished.php";
        </script>
<?php
    } else {
...
<body>
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            <?php
            $selQry = "SELECT * FROM tbl_booking b INNER JOIN tbl_user u ON u.user_id = b.user_id WHERE b.branch_id=" . $_SESSION['bid'] . " AND b.booking_status = 4";
            $res = $con->query($selQry);
            $i = 0;
