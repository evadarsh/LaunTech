        ...
        while ($data = $res->fetch_assoc()) {
            ...
            <tr>
                ...
                <td>
                    ...
                    if ($data['booking_status'] == 0) {
                        ?>
                        <a href="Bookings1.php?bid=<?php echo $data['booking_id'] ?>&st=1" class="btn btn-primary">Accept</a><br>
                        <a href="Bookings1.php?bid=<?php echo $data['booking_id'] ?>&st=2" class="btn btn-danger">Reject</a>
                        <?php
                    } else if ($data['booking_status'] == 1) {
                        ?>
                        <a href="Bookings1.php?bid=<?php echo $data['booking_id'] ?>&st=3" class="btn btn-success">Cloth Picked Up</a><br>
                        <?php
                    } else if ($data['booking_status'] == 3) {
                        ?>
                        <a href="Bookings1.php?bid=<?php echo $data['booking_id'] ?>&st=4" class="btn btn-success">Washing Finished</a><br>
                        <?php
                    } else if ($data['booking_status'] == 5) {
                        ?>
                        <a href="Bookings1.php?bid=<?php echo $data['booking_id'] ?>&st=6" class="btn btn-success">Cloth Returned</a><br>
                        <?php
                    }
                    ?>
                </td>
